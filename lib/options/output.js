...
module.exports = function(proto) {
  ...
  /**
   * Specify MPEG-DASH adaptation sets for the output manifest file
   *
   * @method FfmpegCommand#adaptationSets
   * @category Output
   *
   * @return FfmpegCommand
   */
  proto.adaptationSets = function(sets) {
    this._currentOutput.options('-adaptation_sets', sets);
    return this;
  }
};
